...
# Notas da versão:
# corrigido problema no pyinstaller definindo add-data no auto-py-to-exe
# adicionando path de música do usário por padrão em qualquer pc
# removida limpeza da exibição da notificação de pasta
...
class Programa:
    ...
    def iniciar_temporizador_inatividade(self):
        ...
        # Configura o temporizador para chamar autolimpar_tela após 60 segundos de inatividade
    ...
    def youtube_login(self):
        return webbrowser.open("https://www.youtube.com/login")
...
if __name__ == "__main__":
    root = Tk()
    root.title("Simple Music Downloader - SMD 0.4.7")
