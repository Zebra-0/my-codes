...
# Notas da versão:
# conversor mp3 agora identifica se já converteu naquela pasta
# se ficar 60 segundos sem digitar as notificações resetam.
...
class Programa:
    ...
    def autolimpar_tela(self):
        ...
        self.canvas.itemconfig(self.titulo_midia, text="")
        self.canvas.itemconfig(self.notificacoes, text="")
    def link(self):
...
if __name__ == "__main__":
    root = Tk()
    root.title("Simple Music Downloader - SMD 0.4.4")
    app = Programa(root)
    root.mainloop()
